...
urlpatterns = [
    ...
    path('admin/clients/create/', views.admin_client_create_view, name='admin_client_create_view'),
    path('admin/clients/<int:client_id>/', views.admin_client_detail_view, name='admin_client_detail_view'),
