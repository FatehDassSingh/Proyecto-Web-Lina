    ...
    try {
      ...
      if (data && typeof data === 'object') {
        setBusinessConfig({
          ...
          bank_name: data.bank_name || 'Banco Santander',
          bank_account_type: data.bank_account_type || 'Cuenta Corriente',
          bank_account_number: data.bank_account_number || '78-90123-45',
          bank_holder_name: data.bank_holder_name || 'Banquetería Lina SpA',
          bank_holder_rut: data.bank_holder_rut || '76.982.100-5',
          bank_email: data.bank_email || 'contacto@banqueterialina.cl',
