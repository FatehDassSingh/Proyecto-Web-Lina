    ...
    <div className="w-full bg-[#120B07] text-[#FAF6F0] min-h-[calc(100vh-80px)] py-16 px-4">
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Misión */}
          <div className="glass-card p-8 space-y-4 border border-[#D9822B]/30 hover:border-[#D9822B] bg-[#1A120C]">
        ...
        {/* Values Banner */}
        <div className="glass-panel p-8 text-center space-y-6 bg-[#1A120C]">
