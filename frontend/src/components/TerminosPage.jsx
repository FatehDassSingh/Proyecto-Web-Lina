...
const DEFAULT_TERMS_HTML = `
  <section class="space-y-2">
    <h3 class="font-serif text-lg font-bold text-[#E5C384]">1. Políticas de Reserva y Anticipación</h3>
    <p>Todos los pedidos y reservas de servicios de banquetería requieren una anticipación mínima estricta de <strong>3 días hábiles</strong> antes de la fecha del evento o retiro. Cualquier modificación o anulación de menú debe realizarse con al menos <strong>7 días hábiles</strong> de antelación.</p>
  </section>
  <section class="space-y-2">
    <h3 class="font-serif text-lg font-bold text-[#E5C384]">2. Modalidades de Servicio y Horarios</h3>
  ...
  <section class="space-y-2">
    <h3 class="font-serif text-lg font-bold text-[#E5C384]">3. Mínimo de Compra</h3>
    <p>Se exige un mínimo de compra de <strong>$70.000 CLP netos</strong> en productos dentro del carrito de compras para habilitar la solicitud de servicio y despliegue operativo.</p>
  </section>
  <section class="space-y-2">
    <h3 class="font-serif text-lg font-bold text-[#E5C384]">4. Pagos y Validación</h3>
...
export default function TerminosPage({ onNavigateHome, businessConfig }) {
  const htmlContent = businessConfig?.terms_and_conditions || DEFAULT_TERMS_HTML;
  ...
  return (
    <div className="py-16 px-4 max-w-4xl mx-auto space-y-10 text-xs text-[#A6988B] leading-relaxed">
      ...
      <div className="border-b border-[#D9822B]/20 pb-6 space-y-2">
        ...
        <p className="text-[#E5C384]">Banquetería Lina - Documento Oficial Oficializado</p>
      </div>

      <div 
        className="space-y-6 bg-[#1A120C] p-8 rounded-2xl border border-[#D9822B]/20 rich-text-container text-xs text-[#FAF6F0]"
